...
<!-- wp:group {"className":"sidebar-entry","style":{"spacing":{"blockGap":"0.75em","margin":{"top":"0","bottom":"1.5em"}}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
...
<!-- wp:group {"className":"sidebar-text","style":{"spacing":{"blockGap":"0.25em"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group sidebar-text"><!-- wp:post-title {"isLink":true,"level":3,"className":"p-name"} /-->
